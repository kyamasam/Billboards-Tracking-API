...
class User extends Authenticatable
{
     ...
     */
    protected $fillable = [
        'name', 'email', 'password','user_name','last_name', 'middle_name', 'first_name', 'msisdn','msisdn_verified', 'account_type', 'avatar', 'cover_photo', 'is_verified', 'is_trusted', 'account_status',
    ];
